...
const BattleLog: React.FC<BattleLogProps> = ({
  ...
  return (
    <div className="fixed inset-y-0 w-[18%] h-[90%] my-auto rounded-xl bg-gray-800 border border-gray-700 backdrop-blur-md shadow-lg">
        ...
        <div className="flex flex-col space-y-4 w-full">
          {turns.map((turn, index) => (
            <div
              key={index}
              className={`flex ${
                turn.attacker === "challenger" ? "justify-end" : "justify-start"
              } w-full`}
            >
              <div
                      ...
                      {turn.statsChanged.attack && (
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            ...
                            {turn.statsChanged.attack} attack
                          </span>
                        </div>
                      )}
                      ...
                      {turn.statsChanged.defense && (
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            ...
                            {turn.statsChanged.defense} defense
                          </span>
                        </div>
                      )}
                      {turn.statsChanged.health && (
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            ...
                            {turn.statsChanged.health} health
                          </span>
                        </div>
                      )}
                    </div>
